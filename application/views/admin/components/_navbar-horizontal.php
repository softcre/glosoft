    ...
    <ul class="navbar-nav ms-auto">
      ...
      <li class="nav-item dropdown user-menu">
        <a href="#" class="nav-link dropdown-toggle" id="userMenuDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
          ...
          <?php if ($urlFoto) : ?>
            <img src="<?= $urlFoto; ?>" class="user-image rounded-circle shadow" alt="User Image">
          <?php else : ?>
            <img src="<?= $this->imagen->getUrlImg('usuarios', 'no-user.jpg'); ?>" class="user-image rounded-circle shadow" alt="User Image default">
          <?php endif; ?>
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end" aria-labelledby="userMenuDropdown">
          ...
          <button type="button" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#large" onclick="cargarFormLarge('<?= base_url(PERFIL_PATH . '/frmEditarContrasena') ?>')">
            <i class="bi bi-key-fill me-2"></i> Cambiar contraseña
          </button>
          <div class="dropdown-divider"></div>
          <button type="button" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#large" onclick="cargarFormLarge('<?= base_url(ADMIN_PATH . '/salir') ?>')">
