...
<div class="modal-header bg-primary text-white py-2">
  <h5 class="modal-title mb-0">Nuevo Verificador</h5>
  <button type="button"
          id="cerrarModal"
...
<div class="modal-body">
  <form id="form_verificador"
        name="verificador"
        method="post"
        action="<?= base_url(VERIFICADORES_PATH . '/crear'); ?>"
        onsubmit="altaUpdate(event)">
        
    <input type="hidden" name="idTipoUsuario" value="4"> <!-- tipo usuario verificador -->

    <?php $this->load->view(VERIFICADORES_PATH . '/_formularioVerificador'); ?>
  </form>
</div>
