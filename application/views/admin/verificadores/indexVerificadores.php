...
<div class="content-wrapper">
  <?php $this->load->view(VERIFICADORES_PATH . '/_headerVerificador'); ?>
    ...
    <div class="container-fluid">
      ...
      <div class="button-container mb-3">
        <button 
          ...
          data-url="<?= base_url(VERIFICADORES_PATH . '/frmNueva') ?>" 
          title="Nuevo Verificador">
          <!-- <i class="bi bi-plus-circle me-1"> --></i><i class="bi bi-person-fill-add me-1"></i> Crear Verificador
        </button>

        <!-- Example secondary button -->
        <!--
        <a href="<?= base_url(VERIFICADORES_PATH); ?>" class="btn btn-secondary">
...
<script src="<?= base_url('assets/admin/js/verificadores.js'); ?>"></script>
