<table id="tblVerificadores" class="table table-sm table-hover align-middle">
  <thead>
            ...
            <div class="collapse collapse-horizontal" id="collapseButtonsMedico<?= $usuario->id_usuario ?>">
              <div class="d-inline-flex align-items-center gap-2 ms-2">
                ...
                <button
                  ...
                  onclick="cargarFormSmall('<?= base_url(VERIFICADORES_PATH . '/frmVer/' . $usuario->id_usuario); ?>')">
                ...
                <button
                  ...
                  data-bs-toggle="modal"
                  data-bs-target="#small"
                  onclick="cargarFormSmall('<?= base_url(VERIFICADORES_PATH . '/frmEditar/' . $usuario->id_usuario); ?>')">
                ...
                <button
                  ...
                  title="Eliminar"
                  data-url="<?= base_url(VERIFICADORES_PATH . '/eliminar/' . $usuario->id_usuario); ?>"
