...
<div class="modal-body">
  <form id="form_newExpediente" name="Expediente" method="post" action="<?= base_url(EXPEDIENTES_PATH . '/crear'); ?>" onsubmit="altaUpdate(event)">
...
<div class="modal-footer bg-light mt-0 py-1">
  ...
  <button type="submit" id="btnFormExpediente" form="form_newExpediente" class="btn btn-success" name="button">
    <div class="d-none">
