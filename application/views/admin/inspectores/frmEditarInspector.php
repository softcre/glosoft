...
<div class="modal-header bg-primary py-2 text-white">
  <h5 class="modal-title mb-0">Actualizar Administrador</h5>
  <button type="button"
          id="cerrarModal"
...
<div class="modal-body">
  <form id="form_adminGamerSport"
        name="adminGamerSport"
        method="post"
...
<div class="modal-footer bg-gradient-dark mt-0 py-1">
  ...
  <button type="submit"
          id="btnFormadminGamerSport"
          form="form_adminGamerSport"
