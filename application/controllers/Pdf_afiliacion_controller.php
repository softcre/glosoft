...
class Pdf_afiliacion_controller extends CI_Controller
{
    ...
    public function pdf_ver($id_afiliacion)
    {
        $data['title'] = 'acta de Afiliación';
        $data['act'] = 'acta';
        $data['desplegado'] = 'exp';
        //$data['torneos'] = $this->torneos->get_all();
        $data['afiliacion'] = $this->afiliaciones->get($id_afiliacion);
        $afiliacion = $this->afiliaciones->get($id_afiliacion);
        $data['nombre_acta'] = 'Acta_afiliacion_num_'.$afiliacion->id_afiliacion;
        ...
        $pdf->load_view_acta_afiliacion('admin/inspecciones/pdf_acta_afiliacion_plantilla', $data)->setPaper('ticket', 'landscape');
